...
run_copilot() {
  ...
  task_prompt="lets implement ${spec_id} in #file:.specs .Update the open tasks in the spec document after completion. Make a commit and push it to the main branch with only the name of the SDD file.
